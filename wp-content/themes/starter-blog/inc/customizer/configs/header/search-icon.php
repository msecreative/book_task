...
class StarterBlog_Builder_Item_Search_Icon {
	...
	function __construct() {
		$this->label = __( 'Search Icon', 'starter-blog' );
	}
	...
	function customize() {
		...
		$config   = array(
			...
			array(
				...
				'label'           => __( 'Icon Padding', 'starter-blog' ),
			),
			...
			array(
				...
				'description' => __( 'Search icon styling', 'starter-blog' ),
				'selector'    => array(
			...
			array(
				...
				'type'    => 'heading',
				'section' => $this->section,
				'label'   => __( 'Modal Settings', 'starter-blog' ),
			),
			...
			array(
				...
				'section'     => $this->section,
				'css_format'  => 'styling',
				'title'       => __( 'Form Styling', 'starter-blog' ),
				'description' => __( 'Form modal styling', 'starter-blog' ),
				'selector'    => array(
			...
			array(
				...
				'label'           => __( 'Search Modal Width', 'starter-blog' ),
			),
	...
	function render() {
		...
		?>
		<a class="search-icon" aria-label="Search" href="#">
...
StarterBlog_Customize_Layout_Builder()->register_item( 'header', new StarterBlog_Builder_Item_Search_Icon() );
